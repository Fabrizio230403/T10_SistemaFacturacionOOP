    ...
    foreach ($archivos as $archivo) {
        echo "<li class='factura-item d-flex justify-content-between align-items-center'>
             <div>
                ...
                <a href='facturas/$archivo' target='_blank' class='mr-3'>$archivo</a>
            </div>
       
            <button class='btn btn-primary btn-enviar-reporte' onclick='openModal(\"$archivo\", \"factura\")'>Enviar Reporte</button>
          </li>";
    }
    echo "</ul>";
    echo "</div>";
